document.body.style.backgroundImage = "url('61feb55262ea7a2e2ac9f5f82555abef.jpg')";
var topmostdiv = document.createElement("div")
document.body.appendChild(topmostdiv)
topmostdiv.backgroundColor = "black"

// nav bar

var navDiv = document.createElement("div");
navDiv.setAttribute("class", "navi navbar-dark")
topmostdiv.appendChild(navDiv)

var nav = document.createElement("nav")
nav.setAttribute("class", "navi navbar navbar-expand-lg navbar-dark")
...
anchortag.setAttribute("class", "navbar-dark")
...
heading.innerText = "Welcome to Makeup ";
heading.style.borderRadius = "6px"
heading.style.fontFamily = "'Estonia', cursive";;
...
jsonDiv.style.backgroundColor = "black"
...
function toggleBtn() {
    var obj = document.getElementById("weathers", "");
